...
export default class Calculate extends Mixins(TestMixin, RelayMixin) {
    ...
    private selectionIsClosed = false;
    ...
    selectedText(): string {
      const selectedNumber = this.selected.length;
